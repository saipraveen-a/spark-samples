...
val configs = Map(
  ...
  "dfs.adls.oauth2.client.id" -> "b24ff7bd-9ab6-4233-857e-8350fc14fc7b",
  "dfs.adls.oauth2.credential" -> "Zehj3UO?kt@aZl_=D6X7zoaA0s=d1hgU",
  "dfs.adls.oauth2.refresh.url" -> "https://login.microsoftonline.com/c9536685-1262-420b-a94b-4f5420284680/oauth2/token")
...
dbutils.fs.mount(
  source = "adl://migrationtest.azuredatalakestore.net/",
  mountPoint = "/mnt/test",
...
spark.conf.set("dfs.adls.oauth2.client.id", "b24ff7bd-9ab6-4233-857e-8350fc14fc7b")
spark.conf.set("dfs.adls.oauth2.credential", "Zehj3UO?kt@aZl_=D6X7zoaA0s=d1hgU")
spark.conf.set("dfs.adls.oauth2.refresh.url", "https://login.microsoftonline.com/c9536685-1262-420b-a94b-4f5420284680/oauth2/token")
